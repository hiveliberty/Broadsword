...
class InsuranceApi(object):
    ...
    def get_insurance_prices(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_insurance_prices(callback=callback_function)
    ...
    def get_insurance_prices_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_insurance_prices_with_http_info(callback=callback_function)
        ...
        resource_path = '/v1/insurance/prices/'.replace('{format}', 'json')
        path_params = {}
