...
class FittingsApi(object):
    ...
    def delete_characters_character_id_fittings_fitting_id(self, character_id, fitting_id, **kwargs):
        ...
        >>> thread = api.delete_characters_character_id_fittings_fitting_id(character_id, fitting_id, async=True)
        >>> result = thread.get()
    ...
    def delete_characters_character_id_fittings_fitting_id_with_http_info(self, character_id, fitting_id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_characters_character_id_fittings_fitting_id_with_http_info(character_id, fitting_id, async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api('/v1/characters/{character_id}/fittings/{fitting_id}/', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_characters_character_id_fittings(self, character_id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_characters_character_id_fittings(character_id, async=True)
        >>> result = thread.get()
    ...
    def get_characters_character_id_fittings_with_http_info(self, character_id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_characters_character_id_fittings_with_http_info(character_id, async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api('/v1/characters/{character_id}/fittings/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_characters_character_id_fittings(self, character_id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_characters_character_id_fittings(character_id, async=True)
        >>> result = thread.get()
    ...
    def post_characters_character_id_fittings_with_http_info(self, character_id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_characters_character_id_fittings_with_http_info(character_id, async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api('/v1/characters/{character_id}/fittings/', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
