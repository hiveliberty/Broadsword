...
class CharacterApi(object):
    ...
    def get_characters_character_id_roles_with_http_info(self, character_id, **kwargs):
        ...
        return self.api_client.call_api('/v2/characters/{character_id}/roles/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_characters_character_id_stats(self, character_id, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_characters_character_id_stats_with_http_info(character_id, **kwargs)
        else:
            (data) = self.get_characters_character_id_stats_with_http_info(character_id, **kwargs)
            return data

    def get_characters_character_id_stats_with_http_info(self, character_id, **kwargs):
        """
        Yearly aggregate stats
        Returns aggregate yearly stats for a character  ---  This route is cached for up to 86400 seconds  --- [This route has an available update](https://esi.tech.ccp.is/diff/latest/dev/#GET-/characters/{character_id}/stats/)
        This method makes a synchronous HTTP request by default. To make an
        ...
        # verify the required parameter 'character_id' is set
        if ('character_id' not in params) or (params['character_id'] is None):
            raise ValueError("Missing the required parameter `character_id` when calling `get_characters_character_id_stats`")
        ...
        return self.api_client.call_api('/v1/characters/{character_id}/stats/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[GetCharactersCharacterIdStats200Ok]',
                                        auth_settings=auth_settings,
                                        async=params.get('async'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def post_characters_character_id_cspa_with_http_info(self, character_id, characters, **kwargs):
        ...
        return self.api_client.call_api('/v4/characters/{character_id}/cspa/', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
