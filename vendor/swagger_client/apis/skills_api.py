...
class SkillsApi(object):
    ...
    def get_characters_character_id_attributes(self, character_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_characters_character_id_attributes(character_id, callback=callback_function)
    ...
    def get_characters_character_id_attributes_with_http_info(self, character_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_characters_character_id_attributes_with_http_info(character_id, callback=callback_function)
        ...
        resource_path = '/v1/characters/{character_id}/attributes/'.replace('{format}', 'json')
        path_params = {}
