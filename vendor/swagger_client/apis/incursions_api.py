...
class IncursionsApi(object):
    ...
    def get_incursions(self, **kwargs):
        """
        List incursions
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_incursions(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_incursions_with_http_info(**kwargs)
        else:
            (data) = self.get_incursions_with_http_info(**kwargs)
            return data

    def get_incursions_with_http_info(self, **kwargs):
        """
        List incursions
        Return a list of current incursions  ---  This route is cached for up to 300 seconds
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_incursions_with_http_info(callback=callback_function)
        ...
        resource_path = '/v1/incursions/'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='list[GetIncursions200Ok]',
