...
class GetCharactersCharacterIdNotifications200Ok(object):
    ...
    def __init__(self, notification_id=None, type=None, sender_id=None, sender_type=None, timestamp=None, is_read=None, text=None):
        """
        GetCharactersCharacterIdNotifications200Ok - a model defined in Swagger
        """
    ...
    def sender_type(self, sender_type):
        ...
        if sender_type is None:
            raise ValueError("Invalid value for `sender_type`, must not be `None`")
        allowed_values = ["character", "corporation", "alliance", "faction", "other"]
