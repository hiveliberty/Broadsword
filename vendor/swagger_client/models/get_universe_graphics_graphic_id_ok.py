...
class GetUniverseGraphicsGraphicIdOk(object):
    ...
    def __init__(self, graphic_id=None, graphic_file=None, sof_race_name=None, sof_fation_name=None, sof_dna=None, sof_hull_name=None, collision_file=None, icon_folder=None):
        """
