...
class GetCorporationsCorporationIdRoles200Ok(object):
    ...
    """
    def __init__(self, character_id=None, grantable_roles=None, grantable_roles_at_base=None, grantable_roles_at_hq=None, grantable_roles_at_other=None, roles=None, roles_at_base=None, roles_at_hq=None, roles_at_other=None):
        """
        GetCorporationsCorporationIdRoles200Ok - a model defined in Swagger
