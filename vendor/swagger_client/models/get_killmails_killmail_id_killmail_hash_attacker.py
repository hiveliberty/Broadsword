...
class GetKillmailsKillmailIdKillmailHashAttacker(object):
    ...
    def __init__(self, character_id=None, corporation_id=None, alliance_id=None, faction_id=None, security_status=None, final_blow=None, damage_done=None, ship_type_id=None, weapon_type_id=None):
        """
