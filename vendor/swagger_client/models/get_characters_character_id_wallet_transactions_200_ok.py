...
class GetCharactersCharacterIdWalletTransactions200Ok(object):
    ...
    def __init__(self, transaction_id=None, date=None, type_id=None, location_id=None, unit_price=None, quantity=None, client_id=None, is_buy=None, is_personal=None, journal_ref_id=None):
        """
        GetCharactersCharacterIdWalletTransactions200Ok - a model defined in Swagger
        """
    ...
    def date(self):
        """
        Gets the date of this GetCharactersCharacterIdWalletTransactions200Ok.
        Date and time of transaction

        :return: The date of this GetCharactersCharacterIdWalletTransactions200Ok.
        :rtype: datetime
        """
        return self._date
    ...
    def date(self, date):
        ...
        :param date: The date of this GetCharactersCharacterIdWalletTransactions200Ok.
        :type: datetime
        """
        if date is None:
