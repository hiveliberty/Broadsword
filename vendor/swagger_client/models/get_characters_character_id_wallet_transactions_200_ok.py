...
class GetCharactersCharacterIdWalletTransactions200Ok(object):
    ...
    """
    def __init__(self, client_id=None, date=None, is_buy=None, is_personal=None, journal_ref_id=None, location_id=None, quantity=None, transaction_id=None, type_id=None, unit_price=None):
        """
