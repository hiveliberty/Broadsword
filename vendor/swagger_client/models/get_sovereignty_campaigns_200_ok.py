...
class GetSovereigntyCampaigns200Ok(object):
    ...
    def __init__(self, campaign_id=None, structure_id=None, solar_system_id=None, constellation_id=None, event_type=None, start_time=None, defender_id=None, defender_score=None, attackers_score=None, participants=None):
        """
