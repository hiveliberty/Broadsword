...
class GetCorporationsCorporationIdContainersLogs200Ok(object):
    ...
    def __init__(self, action=None, character_id=None, container_id=None, container_type_id=None, location_flag=None, location_id=None, logged_at=None, new_config_bitmask=None, old_config_bitmask=None, password_type=None, quantity=None, type_id=None):
        """
