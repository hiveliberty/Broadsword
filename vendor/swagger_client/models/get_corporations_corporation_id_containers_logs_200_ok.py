...
class GetCorporationsCorporationIdContainersLogs200Ok(object):
    ...
    def __init__(self, logged_at=None, container_id=None, container_type_id=None, character_id=None, location_id=None, location_flag=None, action=None, password_type=None, type_id=None, quantity=None, old_config_bitmask=None, new_config_bitmask=None):
        """
        GetCorporationsCorporationIdContainersLogs200Ok - a model defined in Swagger
        """
    ...
    def action(self, action):
        ...
        allowed_values = ["add", "assemble", "configure", "enter_password", "lock", "move", "repackage", "set_name", "set_password", "unlock"]
