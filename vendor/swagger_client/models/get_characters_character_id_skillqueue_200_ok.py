...
class GetCharactersCharacterIdSkillqueue200Ok(object):
    ...
    def __init__(self, skill_id=None, finish_date=None, start_date=None, finished_level=None, queue_position=None, training_start_sp=None, level_end_sp=None, level_start_sp=None):
        """
