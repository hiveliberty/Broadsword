...
class GetCorporationCorporationIdMiningObservers200Ok(object):
    ...
    def __init__(self, last_updated=None, observer_id=None, observer_type=None):
        """
        GetCorporationCorporationIdMiningObservers200Ok - a model defined in Swagger
        """
    ...
    def observer_type(self, observer_type):
        ...
        if observer_type is None:
            raise ValueError("Invalid value for `observer_type`, must not be `None`")
        allowed_values = ["structure"]
