...
class GetIncursions200Ok(object):
    ...
    def __init__(self, type=None, state=None, influence=None, has_boss=None, faction_id=None, constellation_id=None, staging_solar_system_id=None, infested_solar_systems=None):
        """
