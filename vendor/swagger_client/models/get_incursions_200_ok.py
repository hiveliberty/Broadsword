...
class GetIncursions200Ok(object):
    ...
    def __init__(self, constellation_id=None, faction_id=None, has_boss=None, infested_solar_systems=None, influence=None, staging_solar_system_id=None, state=None, type=None):
        """
        GetIncursions200Ok - a model defined in Swagger
        """
