...
class GetDogmaEffectsEffectIdOk(object):
    ...
    def __init__(self, effect_id=None, name=None, display_name=None, description=None, icon_id=None, effect_category=None, pre_expression=None, post_expression=None, is_offensive=None, is_assistance=None, disallow_auto_repeat=None, published=None, is_warp_safe=None, range_chance=None, electronic_chance=None, duration_attribute_id=None, tracking_speed_attribute_id=None, discharge_attribute_id=None, range_attribute_id=None, falloff_attribute_id=None, modifiers=None):
        """
