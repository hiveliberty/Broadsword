...
class GetUniverseTypesTypeIdOk(object):
    ...
    """
    def __init__(self, capacity=None, description=None, dogma_attributes=None, dogma_effects=None, graphic_id=None, group_id=None, icon_id=None, market_group_id=None, mass=None, name=None, packaged_volume=None, portion_size=None, published=None, radius=None, type_id=None, volume=None):
        """
