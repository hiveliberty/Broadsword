...
class GetFleetsFleetIdMembers200Ok(object):
    ...
    def __init__(self, character_id=None, ship_type_id=None, wing_id=None, squad_id=None, role=None, role_name=None, join_time=None, takes_fleet_warp=None, solar_system_id=None, station_id=None):
        """
