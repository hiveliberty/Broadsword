...
class GetCharactersCharacterIdOrders200Ok(object):
    ...
    def __init__(self, order_id=None, type_id=None, region_id=None, location_id=None, range=None, is_buy_order=None, price=None, volume_total=None, volume_remain=None, issued=None, state=None, min_volume=None, account_id=None, duration=None, is_corp=None, escrow=None):
        """
