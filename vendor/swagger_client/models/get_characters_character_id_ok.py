...
class GetCharactersCharacterIdOk(object):
    ...
    def __init__(self, name=None, description=None, corporation_id=None, alliance_id=None, birthday=None, gender=None, race_id=None, bloodline_id=None, ancestry_id=None, security_status=None, faction_id=None):
        """
