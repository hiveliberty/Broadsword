...
class GetAlliancesAllianceIdNotFound(object):
    """
    ...
    def __init__(self, error=None):
        """
        GetAlliancesAllianceIdNotFound - a model defined in Swagger
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, GetAlliancesAllianceIdNotFound):
            return False
