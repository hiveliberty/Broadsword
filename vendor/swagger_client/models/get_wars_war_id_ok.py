...
class GetWarsWarIdOk(object):
    ...
    def __init__(self, id=None, declared=None, started=None, retracted=None, finished=None, mutual=None, open_for_allies=None, aggressor=None, defender=None, allies=None):
        """
