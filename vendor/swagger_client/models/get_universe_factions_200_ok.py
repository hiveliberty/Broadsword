...
class GetUniverseFactions200Ok(object):
    ...
    def __init__(self, faction_id=None, name=None, description=None, solar_system_id=None, corporation_id=None, militia_corporation_id=None, size_factor=None, station_count=None, station_system_count=None, is_unique=None):
        """
