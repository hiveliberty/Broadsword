...
class GetCorporationsCorporationIdTitles200Ok(object):
    ...
    def __init__(self, title_id=None, name=None, roles=None, grantable_roles=None, roles_at_hq=None, grantable_roles_at_hq=None, roles_at_base=None, grantable_roles_at_base=None, roles_at_other=None, grantable_roles_at_other=None):
        """
