...
class GetCharactersCharacterIdAttributesOk(object):
    ...
    def __init__(self, charisma=None, intelligence=None, memory=None, perception=None, willpower=None, bonus_remaps=None, last_remap_date=None, accrued_remap_cooldown_date=None):
        """
