...
class GetFwSystems200Ok(object):
    ...
    def __init__(self, contested=None, occupier_faction_id=None, owner_faction_id=None, solar_system_id=None, victory_points=None, victory_points_threshold=None):
        """
